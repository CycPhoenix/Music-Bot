...
module.exports = class loop extends Interaction {
    constructor() {
        super({
            name: 'help',
            description: 'See commands of the bot',
            options: [
                {
                    type: '3',
                    name: 'category',
    ...
    async exec(int, data) {
        ...
        const music = new MessageEmbed()
            .setDescription(
                `${this.client.emotes.get('suprememusic')} __**Music Commands**__ 
                ...
                \n${this.client.emotes.get('supremedot')} \`/skipto    :\` Skips all the songs up to your choice.
        ...
        const info = new MessageEmbed()
            ...
            .setDescription(`${this.client.emotes.get('supremedot')} \`/help      :\` Shows the category commands.`)
            .setColor(`#FFFFFF`)
