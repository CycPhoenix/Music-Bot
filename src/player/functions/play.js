...
module.exports = async function play(
    ...
    await queue.join(channel).catch((err) => {
        const nojoin = new MessageEmbed()
            .setDescription(`${client.emotes.get('supremenomusic')} ** I Couldn't Join The Voice Channel!** \n ${client.emotes.get('supremeblank')}${client.emotes.get(supremelink)} Support: [Server]()`)
            .setColor(`#FFFFFF`)
    ...
    if (playlist) {
        ...
        const noplay1 = new MessageEmbed()
            .setDescription(`${client.emotes.get(supremeno)} ** I couldn't found that playlist!** \n ${client.emotes.get('supremeblank')}${client.emotes.get('supremelink')} Support: [Server]()`)
            .setColor(`#FFFFFF`)
        ...
        if (force) {
            ...
            const nosongg = new MessageEmbed()
                .setDescription(`${client.emotse.get('supremeno')} ** I couldn't found that song!** \n ${client.emotes.get('supremeblank')}${client.emotes.get('supremelink')} Support: [Join Server]()`)
                .setColor(`#FFFFFF`)
            ...
            const nosonggg = new MessageEmbed()
                .setDescription(`${client.emotes.get('supremeno')} ** I couldn't found that song!** \n ${client.emotes.get('supremeblank')}${client.emotes.get('supremelink')} Support: [Join Server]()`)
                .setColor(`#FFFFFF`)
